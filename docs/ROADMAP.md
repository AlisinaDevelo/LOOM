...
| **Q05** | 2027-08-23 – 2027-11-22 | Pattern — Intentional capture | Define least-privilege browser capture. The [browser protocol](protocol/browser-capture-v1.md) and [explicit-save connector](../browser-extension/README.md) bind visible actions, provenance fields, authenticated envelopes, and best-effort snapshot states before host integration. |
