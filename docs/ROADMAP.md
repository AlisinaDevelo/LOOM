...
| **Q05** | 2027-08-23 – 2027-11-22 | Pattern — Intentional capture | Define least-privilege browser capture. Live URLs, best-effort snapshots, capture status, timestamps, hashes, parser versions, and failure reasons remain distinct. |
