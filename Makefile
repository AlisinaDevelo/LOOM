.PHONY: install fmt fmt-check lint test benchmark build security-check roadmap-check check verify-device tauri-dev
...
check: lint test benchmark build security-check roadmap-check
